...
/**
 * Adapter that allows an AdapterFeatureController to be used where a
 * PlayerActionFeatures
 * is required. This allows our player actions features with the newly created
 * adapted controller.
 */
public class PlayerActionListenerAdapter implements PlayerActionListener {
  ...
  /**
   * Constructs a PlayerActionFeaturesAdapter that wraps an
   * AdapterFeatureController.
   *
