 ...
 */
class CardShape extends Path2D.Double implements ICardShape {
   ...
   */
  public CardShape(String name, String north, String south, String east, String west, TeamColor color) {
    this.name = name;
...
class CardPanel extends JPanel {
  ...
  protected void paintComponent(Graphics g) {
    ...
    if (cardShape.getColor().equals(TeamColor.RED)) {
      g2.setColor(Color.RED);
    } else if (cardShape.getColor().equals(TeamColor.BLUE)) {
    ...
    g2.drawString(valueToString(cardShape.getNorth()), getWidth() / 2 - 5, 15);
    g2.drawString(valueToString(cardShape.getSouth()), getWidth() / 2 - 5, getHeight() - 5);
    g2.drawString(valueToString(cardShape.getEast()), getWidth() - 15, getHeight() / 2);
    g2.drawString(valueToString(cardShape.getWest()), 5, getHeight() / 2);
  }
